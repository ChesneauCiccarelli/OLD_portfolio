      ...
      <div class="section_D z-10 section_D--mobile"> 
          <div class="section_D-container">
            <div class="section_D-item">
              <img class="IMG_project z-[1]" src="../../public/img/ww-figma.png" alt="Layout Women's Work"/>
          ...
          <div class="section_D-container">
            <div class="section_D-item">
              <img class="IMG_project z-[1]" src="../../public/img/ww-vscode.png" alt="VSCode software"/>
              <div class="IMG_project-description">
                <h1>HTML / CSS</h1>
          ...
          <div class="section_D-container">
            <div class="section_D-item">
              <img class="IMG_project z-[1]" src="../../public/img/ww-planemockup.jpg" alt="Use of Women's Work"/>
              <div class="IMG_project-description">
                <h1>Final Product</h1>
          ...
          <div class="section_D-container">
            <div class="section_D-item">
              <img class="IMG_project z-[1]" src="../../public/img/ww-cdc.png" alt="Terms of reference of Women's Work"/>
              <div class="IMG_project-description">
                <h1>Communication</h1>
