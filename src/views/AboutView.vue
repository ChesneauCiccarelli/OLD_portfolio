<template>
  <colors class="colors_absolute"/>

  <section id="hero" class="about_hero--mobile">
    <article class="hero">
      <div>
        <h1 class="hero_txt">About Me<span></span></h1>
      </div>
    </article>
  </section>

  <section id="mousemouseanim_wrapper" class="about_hero--tablet">
    <span class="mouseanim_txt mouseanim_base">About&nbsp;Me</span>
    <span class="mouseanim_txt mouseanim_outline">About&nbsp;Me</span>
    <span class="mouseanim_txt mouseanim_outline">About&nbsp;Me</span>
    <span class="mouseanim_txt mouseanim_outline">About&nbsp;Me</span>
    <span class="mouseanim_txt mouseanim_outline">About&nbsp;Me</span>
    <span class="mouseanim_txt mouseanim_outline">About&nbsp;Me</span>
  ...
  <section>
    <article class="about">
      <div class="about_innercontainer">
        ...
        <div class="contact mt-[10rem] down">
          ...
          <div class="contact-btn-container">
            <span class="BTN_twist">
              <a href="mailto:contact@lilianchesneau.com"></a>
            </span>
          </div>
        ...
        <svg class="ml-[-2rem] mr-[-2rem] mb-[5rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#1b1c1e" fill-opacity="1" d="M0,224L48,218.7C96,213,192,203,288,176C384,149,480,107,576,112C672,117,768,171,864,213.3C960,256,1056,288,1152,288C1248,288,1344,256,1392,240L1440,224L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
        </svg>
      </div>
    </article>
  </section>
...
<script>
  ...
  export default {
    ...
    mounted() {
      const allText = document.querySelectorAll(".mouseanim_txt");
      ...
      allText.forEach((el, idx) => {
        ...
        el.classList.add("mouseanim_base");

        delay += 0.15;
      });

      document.getElementById("mousemouseanim_wrapper").addEventListener("mousemove", (e) => {
...
<style>
  /* ===== Hero Animation ===== */
  section#mousemouseanim_wrapper {
    width: 100%;
    height: 100vh;
    position: relative;
    overflow: hidden;
  ...
  span.mouseanim_base {
    animation: up-down 2.5s ease-in-out infinite alternate, rotate 5s ease-in-out infinite alternate;
  }
  @keyframes up-down {
    0% {
      transform: translate(-50%, -50%) translateY(-50px)
  ...
  button.BTN_form:hover .BTN_form-wrapperSVG {
    animation: fly-1 0.6s ease-in-out infinite alternate;
  }
  button.BTN_form:hover svg {
    transform: translateX(1.2em) rotate(45deg) scale(1.1);
  }
  button.BTN_form:hover span {
